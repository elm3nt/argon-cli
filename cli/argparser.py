...
tigress_obfuscate_option._optionals.title=' obfuscate usage:  obfuscate [-o] [-i] [-nv] [-ol  [...]]'
...
se_parser._optionals.title = ' symbolic execution usage: argon {all,angr,klee} [-na] [-la] [-ni] [-li] [-t] [-m] [-s]'
