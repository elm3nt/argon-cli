...
se_parser.add_argument('-la', '--length-arg', type = int, default = 0, help = 'enter length of arguments for the program')
se_parser.add_argument('-ni', '--num-input', type = int, default = 0, help = 'enter number of inputs for the program')
se_parser.add_argument('-li', '--length-input', type = int, default = 0, help = 'enter length of inputs for the program')
...
se_parser.add_argument('-m', '--memory', required = False, default = 2000, type = int, help = 'enter memory limit for symbolic analyzer')
...
sub_parser.add_parser('se', parents = [common_parser, se_parser])
sub_parser.add_parser('symbolic-execution', parents = [common_parser, se_parser])
